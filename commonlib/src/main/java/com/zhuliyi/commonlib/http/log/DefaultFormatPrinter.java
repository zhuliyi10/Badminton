 ...
 */
package com.zhuliyi.commonlib.http.log;
...
import com.zhuliyi.commonlib.utils.CharacterUtils;
...
public class DefaultFormatPrinter implements FormatPrinter {
    ...
    public void printJsonResponse(long chainMs, boolean isSuccessful, int code, @NonNull String headers, @Nullable MediaType contentType,
        ...
        bodyString = LogInterceptor.isJson(contentType) ? CharacterUtils.jsonFormat(bodyString)
                : LogInterceptor.isXml(contentType) ? CharacterUtils.xmlFormat(bodyString) : bodyString;
