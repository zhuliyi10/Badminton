...
import com.zhuliyi.commonlib.utils.UrlEncoderUtils;
import com.zhuliyi.commonlib.utils.ZipUtils;
...
public class LogInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (httpHandler != null)//这里可以比客户端提前一步拿到服务器返回的结果,可以做一些操作,比如token超时,重新获取
